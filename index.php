...
<main class="container">
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            {?>
                <li class="promo__item promo__item--<?=$mc['eng']?>">
                    <a class="promo__link" href="pages/all-lots.html"><?=$mc['rus']?></a>
                </li>
                <?php
            }
            ?>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$in['url-img']?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$in['category']?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$in['name']?></a></h3>
